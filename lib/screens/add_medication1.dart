// ignore_for_file: library_private_types_in_public_api, non_constant_identifier_names, unused_element, must_be_immutable, avoid_print

import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:project/components/category_model.dart';
...
import 'package:project/screens/add_medication2.dart';
                            ...
                            if (_selectedCategoryIndex == index) {
                              ...
                              if (_selectedCategoryIndex != -1) {
                                widget.categories[_selectedCategoryIndex]
                                        .boxColor =
                                    const Color.fromARGB(255, 171, 194, 211);
                                widget.categories[_selectedCategoryIndex]
                                    .isSelected = false;
                              }
                              ...
                              widget.categories[index].boxColor =
                                  const Color.fromRGBO(4, 95, 165, 1)
                                      .withOpacity(0.3);
