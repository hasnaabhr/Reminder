// ignore_for_file: library_private_types_in_public_api, non_constant_identifier_names, avoid_print, unnecessary_string_interpolations, prefer_interpolation_to_compose_strings, use_build_context_synchronously, prefer_const_constructors, unused_element
...
import 'package:project/screens/add_medication4.dart';

import 'add_medi_frequency.dart';

class AddMedication3 extends StatefulWidget {
  const AddMedication3({super.key});
                  ...
                  for (int index = 0; index < selectedTimes.length; index++)
                    ListTile(
                      ...
                      title: TextField(
                        ...
                        cursorColor: const Color.fromRGBO(4, 95, 165, 1),
                        decoration: InputDecoration(
                ...
                title: TextField(
                  onTap: () {
                    ...
                    if (selectedTimes.isEmpty) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          backgroundColor: Color.fromRGBO(4, 95, 165, 1),
                          behavior: SnackBarBehavior.floating,
                          duration: Duration(seconds: 2),
                          content: Text(
